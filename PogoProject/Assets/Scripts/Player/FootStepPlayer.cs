...
public class FootStepPlayer : MonoBehaviour
{
    ...
    public GameObject SnowFootStepVFX;
    public GameObject StoneFootStepVFX;
    ...
    public void PlayStoneSFX()
    {
        ...
        if (AttackScript.Instance.left)
        {
            var pref = Instantiate(StoneFootStepVFX, Controller.Instance.groundCheckPos.position, Quaternion.Euler(Quaternion.identity.eulerAngles.x + 75, Quaternion.identity.eulerAngles.y, Quaternion.identity.eulerAngles.z), null);
            Destroy(pref, 3f);
        }
        else
        {
    ...
    public void PlaySnowSFX()
    {
        ...
        if (AttackScript.Instance.left)
        {
            var pref = Instantiate(SnowFootStepVFX, Controller.Instance.groundCheckPos.position, Quaternion.Euler(Quaternion.identity.eulerAngles.x + 75, Quaternion.identity.eulerAngles.y, Quaternion.identity.eulerAngles.z), null);
            Destroy(pref, 3f);
        }
        else
        {
